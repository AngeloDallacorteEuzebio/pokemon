...
@section('content')    
    <form class="max-w-sm mx-auto" action="{{ url('pokemon') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-5">
            <label for="power" class="block mb-2 text-sm font-medium text-white">Power</label>
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded" type="submit">Create Pokemon
